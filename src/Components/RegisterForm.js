...
function RegisterForm(props) {
  ...
  return (
    <>
      <div className="w-110 bg-white-darker rounded-xl flex flex-col justify-center items-center">
        <span className="text-3xl text-blue-dark text-center mt-20 header-welcome-text">New User? Let's get started.</span>
        <form className="p-20 pt-10 w-98 flex flex-col">
          ...
          <Button
            ...
            type="button"
            text="Continue"
            id="register-sign-up-btn"
            handleClick={props.onSubmit}
            />
          <TextLink
            text="Already enrolled? Sign in."
            href="/"
            classOverride="mt-3"
